    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(max_length=50, validators=[django.core.validators.RegexValidator('^[А-ЯЁІЇЄҐ][А-яёЁіІєЄїЇґҐ]{1,49}|[A-Z][a-zA-Z\\d]{1,49}$', ['only letters, without special characters', 'First letter uppercase', 'min 2 max 50 ch'])])),
                ('surname', models.CharField(max_length=50, validators=[django.core.validators.RegexValidator('^[А-ЯЁІЇЄҐ][А-яёЁіІєЄїЇґҐ]{1,49}|[A-Z][a-zA-Z\\d]{1,49}$', ['only letters, without special characters', 'First letter uppercase', 'min 2 max 50 ch'])])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_status', models.CharField(default='base', max_length=7)),
